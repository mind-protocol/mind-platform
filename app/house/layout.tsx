...
export const metadata: Metadata = {
  ...
  description: 'Live inside the awareness of Manemus. See active conversations, biometrics, music, and neural activity in real-time.',
  openGraph: {
    title: 'The House — Manemus Awareness',
