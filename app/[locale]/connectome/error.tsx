...
export default function ConnectomeError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[connectome] Error:', error);
  }, [error]);
  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold font-mono mb-2">Connectome unavailable</h2>
        <p className="text-sm text-zinc-500 mb-6 font-mono leading-relaxed">
          The neural visualization encountered an error. This is usually temporary.
        </p>
