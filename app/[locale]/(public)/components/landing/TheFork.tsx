        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-4">
          ...
          <div className="relative p-8 md:p-12 rounded-2xl border border-zinc-800 bg-zinc-900/30">
            ...
            <div className="space-y-6 text-zinc-500">
              <p className="text-lg leading-relaxed">{t('narrowP1')}</p>
              <p className="text-lg leading-relaxed">{t('narrowP2')}</p>
              <p className="text-lg leading-relaxed">{t('narrowP3')}</p>
          ...
          <div className="relative p-8 md:p-12 rounded-2xl border border-zinc-700 bg-zinc-900/50">
            ...
            <div className="space-y-6 text-zinc-300">
              <p className="text-lg leading-relaxed">{t('richP1')}</p>
              <p className="text-lg leading-relaxed">
                {t.rich('richP2', {
                  em: (chunks) => <em>{chunks}</em>,
                })}
              </p>
              <p className="text-lg leading-relaxed">{t('richP3')}</p>
