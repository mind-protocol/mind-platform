  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold font-mono mb-2">The house is dark</h2>
        <p className="text-sm text-zinc-500 mb-6 font-mono leading-relaxed">
          Something went wrong loading the house. The awareness stream may be temporarily unavailable.
        </p>
